...
class Permissoes extends CI_Controller {
    ...
    function adicionar() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $permissoes = array(
                  ...
                  'rEstoque' => $this->input->post('rEstoque'),
                  'rFinanceiro' => $this->input->post('rFinanceiro'),

                  'aEstoque' => $this->input->post('aEstoque'),
                  'eEstoque' => $this->input->post('eEstoque'),
                  'dEstoque' => $this->input->post('dEstoque'),
    ...
    function excluir(){
        ...
        if($this->permissoes_model->delete('permissoes','idPermissao',$id) == FALSE){             
