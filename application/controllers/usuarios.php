...
class Usuarios extends CI_Controller {
    ...
    function adicionar(){  
        ...
        {     
			...
			{
				auditoria('Inclusão de usuário', 'Usuário "'.set_value('nome').'" cadastrado no sistema');
    ...
    function editar(){  
        ...
        $this->form_validation->set_rules('observacaoUsuario', 'Observação', 'trim|xss_clean');
        ...
        { 
			...
			{
				auditoria('Alteração de usuários', 'Alterado cadastro do usuário "'.$this->input->post('nome').'"');
