  <head>
    <title>Atual ERP - Sistema Administrativo</title>
    <meta charset="UTF-8" />
              ...
              <div class="span12">
                  ...
                  <div class="widget-box">
                      <div class="widget-title">
                          <h4 style="text-align: center">Compras</h4>
                      </div>
                  ...
                  <table class="table table-bordered">
                      <thead>
                          <tr>
                              <th style="font-size: 1.2em; padding: 5px;">Pessoa</th>
                              <th style="font-size: 1.2em; padding: 5px;">Total</th>
                              <th style="font-size: 1.2em; padding: 5px;">Data</th>
                              <th style="font-size: 1.2em; padding: 5px;">Comprador</th>
                          </tr>
                      </thead>
                      <tbody>
                          <?php
