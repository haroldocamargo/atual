    ...
    <div class="span4">
        <div class="widget-box">
            ...
            <div class="widget-content">
                <ul class="site-stats">
                    <li><a href="<?php echo base_url()?>index.php/relatorios/comprasRapid"><i class="icon-tags"></i> <small>Todas as Compras</small></a></li>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <div class="span12 well">
                    ...
                    <form action="<?php echo base_url() ?>index.php/relatorios/comprasCustom" method="get">
                        <div class="span12 well">
                            <div class="span6">
