            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal" >
                     <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="descricao" class="input-xxlarge" type="text" name="descricao" maxlength="80" value="<?php echo set_value('descricao'); ?>"  />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="unidade" class="input-mini" type="text" name="unidade" maxlength="2" value="<?php echo set_value('unidade'); ?>"  />
                        </div>
                    </div>
                    ...
                    <div class="control-group" class="control-label">
                        ...
                        <div class="controls">
                            <textarea class="span12" name="observacaoProduto" id="observacaoProduto" cols="30" rows="5" value="<?php echo set_value('observacaoProduto'); ?>"></textarea>
                        </div>
                    </div>
