                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['eEstoque'])){ if($permissoes['eEstoque'] == '1'){echo 'checked';}}?> name="eEstoque" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar Estoque</span>
                                        </label>
                                    </td>

                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['dEstoque'])){ if($permissoes['dEstoque'] == '1'){echo 'checked';}}?> name="dEstoque" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Excluir Estoque</span>
                                        </label>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Relatório Pessoa</span>
                                        </label>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['rEstoque'])){ if($permissoes['rEstoque'] == '1'){echo 'checked';}}?> name="rEstoque" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Relatório Estoque</span>
                                        </label>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vAuditoria'])){ if($permissoes['vAuditoria'] == '1'){echo 'checked';}}?> name="vAuditoria" class="marcar" type="checkbox" value="1" />
