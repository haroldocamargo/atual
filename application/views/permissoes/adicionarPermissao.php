                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input name="eEstoque" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input name="dEstoque" class="marcar" type="checkbox" value="1" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input name="rEstoque" class="marcar" type="checkbox" value="1" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input name="vAuditoria" class="marcar" type="checkbox" value="1" />
