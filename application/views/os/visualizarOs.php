                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 18%; text-align: center">#Os: <span ><?php echo $result->idOs?></span></br> </br> <span>Emissão: <?php echo date('d/m/Y')?></span></br> </br> <span >Documento: <?php echo $result->documentoOs?></span> </td>
                                </tr>
