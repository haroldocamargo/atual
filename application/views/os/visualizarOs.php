                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 18%; text-align: center">#Os: <span ><?php echo $result->idOs?></span></br> <span>Emissão: <?php echo date('d/m/Y')?></span></br> <span >Documento: <?php echo $result->documentoOs?></span></br> <span>Setor: <?php echo $result->setorOs;?></span> </td>
                                </tr>
