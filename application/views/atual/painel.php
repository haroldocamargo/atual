    ...
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vCliente')){ ?>
            <li class="bg_lb"> <a href="<?php echo base_url()?>index.php/clientes"> <i class="icon-group"></i> Pessoas</a> </li>
        <?php } ?>
        ...
        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vCompra')){ ?>
            <li class="bg_lh"> <a href="<?php echo base_url()?>index.php/compras"><i class="icon-edit"></i> Compras</a></li>
        <?php } ?>
        ...
        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vEstoque')){ ?>
            <li class="bg_lr"> <a href="<?php echo base_url()?>index.php/estoque"><i class="icon-folder-close"></i> Estoque</a></li>
        <?php } ?> 
        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vLancamento')){ ?>
            <li class="bg_lv"> <a href="<?php echo base_url()?>index.php/financeiro"><i class="icon icon-money"></i> Financeiro</a></li>
        <?php } ?>
      </ul>
    </div>
  </div>  
