        ...
        <div class="widget-box">
            ...
            <div class="widget-content" id="printOs">
                <div class="invoice-content">
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 15%; text-align: center; font-size: 10px; ">#Compra: <span  style="font-size: 10px; "><?php echo $result->idCompras?></span></br> <span style="font-size: 10px; ">Emissão: <?php echo date('d/m/Y');?></span></td>
                                    <td style="width: 15%; text-align: center; font-size: 10px; ">Documento: <span  style="font-size: 10px; "><?php echo $result->documentoCompra?></span></br><span style="font-size: 10px; ">Data: <?php echo date('d/m/Y h:m:s', strtotime($result->dataDocumentoCompra));?></span></br><span style="font-size: 10px; ">Setor: <?php echo $result->setorCompra;?></span></td>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width: 50%; padding-left: 0">
                                        <ul>
                                            <li>
                                                <span style="font-size: 12px;">Comprador</span><br/>
                    ...
                    <?php if($result->observacaoCompra != null){?>
			                                            <li>
	                    <span style="font-size: 12px;">Observações: </span><span style="font-size: 10px;"><?php echo $result->observacaoCompra?></span>
			                                            </li>
                    <?php }?>
