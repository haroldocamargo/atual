            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formUsuario" method="post" class="form-horizontal" >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
							<select name="estado" class="span2">
								<option value="value="<?php echo set_value('estado'); ?>""><?php echo set_value('estado'); ?></option>
                    ...
                    <div class="control-group" class="control-label">
                        <label for="observacaoUsuario" class="control-label">Observação</label>
                        <div class="controls">
                            <textarea class="span12" name="observacaoUsuario" id="observacaoUsuario" cols="30" rows="5" value="<?php echo set_value('observacaoUsuario'); ?>"></textarea>
                        </div>
                    </div>
