                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 18%; text-align: center">Documento: <span ><?php echo $result->documentoVenda?></span></br> </br> <span>Data: <?php echo date('d/m/Y', strtotime($result->dataDocumentoVenda));?></span></br> </br><span>Setor: <?php echo $result->setorVenda;?></span></td>
                                </tr>
