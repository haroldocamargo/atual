...
<html lang="pt-br">
  <head>
    <meta charset="utf-8">
    <title>Conecte - Área da Pessoa</title>
  ...
  <body>
    ...
    <!--Header-part-->
    <div id="header">
      <h1><a href="dashboard.html">Atual ERP - Sistema Administrativo</a></h1>
    </div>
    <!--close-Header-part--> 
    ...
    <div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-list"></i> Menu</a>
      <ul>
        ...
        <li class="<?php if(isset($menuVendas)){echo 'active';};?>"><a href="<?php echo base_url()?>index.php/conecte/vendas"><i class="icon icon-shopping-cart"></i> <span>Vendas</span></a></li>
        <li class="<?php if(isset($menuCompras)){echo 'active';};?>"><a href="<?php echo base_url()?>index.php/conecte/compras"><i class="icon icon-edit"></i> <span>Compras</span></a></li>
    ...
    <!--Footer-part-->
    <div class="row-fluid">
      <div id="footer" class="span12">&copy; 2014 | Todos os direitos reservados para <a href="http://www.atualinformaticataubate.com.br">Atual Informática Taubaté Ltda</div>
    </div>
