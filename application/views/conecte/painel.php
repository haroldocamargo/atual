  ...
  <div class="quick-actions_homepage">
    <ul class="quick-actions">
      ...
      <li class="bg_ls span3"> <a href="<?php echo base_url()?>index.php/conecte/compras"><i class="icon-folder-plus"></i> Compras</a></li>
                  ...
                  <tbody>
                      ...
                      if($compras != null){
                          foreach ($compras as $p) {
                              ...
                              echo '<tr>';
                              echo '<td>'.$p->idCompras.'</td>';
                              echo '<td>'.date('d/m/Y',strtotime($p->dataCompra)).'</td>';
                              echo '<td>'.$p->nome.'</td>';
                              echo '<td>'.$faturado.'</td>';
                              echo '<td> <a href="'.base_url().'index.php/conecte/visualizarCompra/'.$p->idCompras.'" class="btn"> <i class="icon-eye-open" ></i> </a></td>';
                              echo '</tr>';
                          }
                      }
                      else{
                          echo '<tr><td colspan="5">Nenhum compra encontrada.</td></tr>';
                      }    
